...
public class UsuarioService implements UserDetailsService {
    ...
    public String gerarQrCode(Usuario logado) {
        var secret = this.totpService.gerarSecret();
        logado.setSecret(secret);
